...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c3ec83ba5c76de1314e35c433814197) *)
(*
     ...
     package =
       {
          ...
          description = Some "Embedded LISP interpreter";
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "standalone.ml"; })
            ];
          plugins =
            [
